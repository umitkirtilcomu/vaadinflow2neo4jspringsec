package com.umitkirtil.demos.vaadinflow2neo4jspringsec.frontend.components.navigation.bar;
...
public class AppBar extends FlexBoxLayout {
    ...
    private void initSearch() {
        ...
        search.setPlaceholder("Filtrele");
    ...
    private void initAvatar() {
        ...
        contextMenu.addItem("Ayarlar",
                e -> Notification.show("Henüz Yapılmadı.", 3000,
                        Notification.Position.BOTTOM_CENTER));
        if (SecurityUtils.isUserLoggedIn()) username = SecurityUtils.getUsername();

        Component separator = new Hr();
        Anchor anchorLogout = new Anchor(contextPath + "/logout", "Güvenli Çıkış");

        contextMenu.add(separator, anchorLogout);
    }
