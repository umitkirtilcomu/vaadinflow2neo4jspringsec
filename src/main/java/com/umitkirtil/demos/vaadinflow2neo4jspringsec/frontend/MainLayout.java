package com.umitkirtil.demos.vaadinflow2neo4jspringsec.frontend;
...
import com.umitkirtil.demos.vaadinflow2neo4jspringsec.frontend.components.navigation.bar.AppBar;
import com.umitkirtil.demos.vaadinflow2neo4jspringsec.frontend.components.navigation.bar.TabBar;
...
//@PWA(name = "Tus Personel Takip Sistemi", shortName = "TUS TAKİP", iconPath = "images/logo-18.png", backgroundColor = "#233348", themeColor = "#233348")
...
public class MainLayout extends FlexBoxLayout
    ...
    private void initNaviItems() {
        ...
        /*NaviItem personnel = menu.addNaviItem(VaadinIcon.USERS, "Personnel",
                null);
        menu.addNaviItem(personnel, "Hakkında", AboutView.class);*/
